...
from simulation.isaac.agents.ppo.evaluation import TrajectoryEvaluationActor, load_evaluation_actor
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Named MLP input/layer profile stored with the training workflow.",
    )
...
def main() -> None:
    ...
    output_path = args.output_dir / f"{args.prefix}_{architecture_profile.name}_{args.date}_{stem}.onnx"
