"""Evaluation command construction, paths, and matrix execution."""
...
from simulation.isaac.trajectory.experiment_models import EvalRequest, ExperimentSpec
...
def _append_eval_context(command: list[str], request: EvalRequest, checkpoint: str) -> None:
    optional_paths = (
...
def build_eval_command(
    ...
    command = _eval_base_command(spec, request, run_name, checkpoint, trajectory)
    _append_eval_context(command, request, checkpoint)
