...
def main():
    ...
    if args_cli.environment_profile is not None:
        env_cfg.environment_profile = args_cli.environment_profile
    ...
    # Evaluation artifacts belong to the selected policy run. Keeping them
    # beside the checkpoint makes one run directory self-contained.
    run_name = agent_cfg.load_run if args_cli.controller == "ppo" else "pid"
    ...
    save_path = os.path.join(log_root_path, run_name, "evaluation", result_dir_name)
        ...
        domain_rows.append(
            {
                ...
                "environment_profile_name": env.unwrapped.cfg.environment_profile_name,
