...
def reset_actuators(env, env_ids: torch.Tensor, stage: int) -> None:
    ...
    if not domain_randomization_feature_enabled(env, "actuators"):
        ...
        env.thruster_dynamics.tau = env.thruster_time_constant
        return
